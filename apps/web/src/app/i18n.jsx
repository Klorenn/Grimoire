...
const dict = {
  en: {
    ...
    inscribe: {
      ...
      chapterPlaceholder: 'e.g. Family, Crypto, Legal',
      seedPhrase: 'Seed phrase',
      words12: '12 words',
      words24: '24 words',
      timeLock: 'Time-lock (optional)',
      timeLockHint: 'Leave empty for immediate access',
      timeLockActive: '⏳ This inscription will be locked until',
      cta2: 'Sign & ✦ Inscribe',
      fileLabel: 'File (PDF, image, scan)',
    ...
    screens: {
      keepers: {
        ...
        title: "The <em>Keepers</em>",
        sub: "Designate heirs who can claim your grimoire if you go quiet. Configure how many must agree and how long the silence must last.",
        heirsLabel: "heir addresses",
        whoInherits: "Who inherits?",
        whoHint: "Enter the wallet addresses of your designated heirs. They must use these wallets to claim.",
        config: "configuration",
        rules: "Rules",
        threshold: "Threshold",
        silence: "Silence window",
        howItWorks: "how it works",
        howBody: "After {period} of silence, {t} of {n} heirs can claim access. Ping anytime to reset the clock.",
        save: "Configure {n} heirs",
        saving: "Saving...",
        saved: "✦ Saved",
        proofOfLife: "proof of life",
        pingTitle: "Ping the grimoire",
        pingSub: "Every inscription, edit, and manual ping resets the dormancy clock.",
        openVault: "Open vault →",
      },
      shared: {
        eyebrow: "Trust & people",
        title: "<em>Shared</em> access",
        sub: "Give time-limited access to specific inscriptions for trusted people.",
        activeGrants: "active grants",
        noGrants: "You haven't shared anything yet",
        grantsHint: "Share an inscription with a wallet address for a limited time.",
        sharedWithMe: "shared with me",
        noShared: "Nothing shared with you",
        sharedHint: "When someone shares an inscription with your wallet, it will appear here.",
      },
      chapters: {
        title: "<em>Chapters</em>",
        sub: "Organize your inscriptions into folders. Create chapters for Family, Crypto, Legal.",
        yourChapters: "your chapters",
        noChapters: "No chapters yet",
        chaptersHint: "Chapters are created automatically when you assign an inscription to one.",
        openVault: "Open your vault →",
      },
      activity: {
        eyebrow: "Trust & people",
        title: "<em>Activity</em> log",
        sub: "Every inscription, proof-of-life, and heir configuration is recorded onchain.",
        events: "onchain events",
        count: "events",
        refresh: "Refresh",
        noEvents: "No events found for your wallet. Create an inscription to get started.",
        loading: "Loading events...",
        inscribed: "Inscribed",
        heirsConfigured: "Heirs configured",
        pinged: "Pinged — proof of life",
        unknown: "Unknown",
      },
      proof: {
        title: "Proof of <em>life</em>",
        sub: "This page shows that a grimoire exists for a wallet — without revealing anything inside.",
        yourProof: "your proof page",
        checking: "Checking...",
        verify: "Verify onchain",
        inscriptions: "inscriptions",
        inscription: "inscription",
        stored: "Stored on Filecoin · Anchored on FEVM",
        noReveal: "No content is revealed. This is a proof of existence only.",
        shareHint: "Share with your heirs so they know the grimoire exists — without giving them access.",
        connect: "Connect your wallet to see your proof page.",
      },
      disconnect: {
        eyebrow: "Account",
        title: "<em>Disconnect</em>",
        sub: "Disconnect your wallet from this grimoire.",
        ready: "Ready to leave?",
        body: "Your inscriptions stay on Filecoin. You can always reconnect.",
  ...
  es: {
    ...
    screens: {
      keepers: {
        eyebrow: "Confianza",
        title: "Los <em>Guardianes</em>",
        sub: "Designa herederos que puedan reclamar tu grimorio si te quedas en silencio.",
        heirsLabel: "direcciones de herederos",
        whoInherits: "¿Quién hereda?",
        whoHint: "Ingresa las direcciones de wallet de tus herederos designados.",
        config: "configuración",
        rules: "Reglas",
        threshold: "Umbral",
        silence: "Ventana de silencio",
        howItWorks: "cómo funciona",
        howBody: "Tras {period} de silencio, {t} de {n} herederos pueden reclamar. Haz ping para reiniciar.",
        save: "Configurar {n} herederos",
        saving: "Guardando...",
        saved: "✦ Guardado",
        proofOfLife: "prueba de vida",
        pingTitle: "Haz ping al grimorio",
        pingSub: "Cada inscripción, edición y ping manual reinicia el reloj.",
        openVault: "Abrir bóveda →",
      },
      shared: {
        eyebrow: "Confianza",
        title: "Acceso <em>compartido</em>",
        sub: "Da acceso por tiempo limitado a inscripciones específicas.",
        activeGrants: "permisos activos",
        noGrants: "No has compartido nada aún",
        grantsHint: "Comparte una inscripción con una dirección de wallet por tiempo limitado.",
        sharedWithMe: "compartido conmigo",
        noShared: "Nada compartido contigo",
        sharedHint: "Cuando alguien comparta una inscripción con tu wallet, aparecerá aquí.",
      },
      chapters: {
        title: "<em>Capítulos</em>",
        sub: "Organiza tus inscripciones en carpetas. Crea capítulos para Familia, Cripto, Legal.",
        yourChapters: "tus capítulos",
        noChapters: "Sin capítulos aún",
        chaptersHint: "Los capítulos se crean al asignar una inscripción a uno.",
        openVault: "Abrir tu bóveda →",
      },
      activity: {
        eyebrow: "Confianza",
        title: "Registro de <em>actividad</em>",
        sub: "Cada inscripción, prueba de vida y configuración de herederos queda registrada onchain.",
        events: "eventos onchain",
        count: "eventos",
        refresh: "Actualizar",
        noEvents: "No se encontraron eventos para tu wallet. Crea una inscripción.",
        loading: "Cargando eventos...",
        inscribed: "Inscrito",
        heirsConfigured: "Herederos configurados",
        pinged: "Ping — prueba de vida",
        unknown: "Desconocido",
      },
      proof: {
        title: "Prueba de <em>vida</em>",
        sub: "Esta página muestra que existe un grimorio para una wallet — sin revelar nada.",
        yourProof: "tu página de prueba",
        checking: "Verificando...",
        verify: "Verificar onchain",
        inscriptions: "inscripciones",
        inscription: "inscripción",
        stored: "Almacenado en Filecoin · Anclado en FEVM",
        noReveal: "No se revela contenido. Esto es solo una prueba de existencia.",
        shareHint: "Comparte con tus herederos para que sepan que el grimorio existe — sin dar acceso.",
        connect: "Conecta tu wallet para ver tu página de prueba.",
      },
      disconnect: {
        eyebrow: "Cuenta",
        title: "<em>Desconectar</em>",
        sub: "Desconecta tu wallet de este grimorio.",
        ready: "¿Listo para salir?",
        body: "Tus inscripciones se quedan en Filecoin. Siempre puedes reconectar.",
        button: "Desconectar wallet",
      },
    },
  },
};
