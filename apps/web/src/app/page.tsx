...
const APARTADOS: Record<string, string> = {
  vault: 'vault', inscribe: 'inscribe', chapters: 'chapters',
  shared: 'shared', keepers: 'keepers', activity: 'activity',
  settings: 'settings', disconnect: 'disconnect', proof: 'proof',
  keep: 'keep', inheritance: 'inheritance', heirs: 'heirs',
  recovery: 'recovery', manifesto: 'manifesto',
};
